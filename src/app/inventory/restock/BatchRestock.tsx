...
export default function BatchRestock() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      {/* Markup settings toolbar */}
      <div className="flex items-center justify-between mb-5">
        <p className="text-sm text-muted-foreground">Import a supplier invoice CSV to restock multiple products at once.</p>
      ...
      {(step === 'mapping' || step === 'review') && (
        <div className="space-y-5 animate-in fade-in duration-300">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1 h-9 px-3 border border-border rounded-lg bg-background focus-within:border-foreground/30 transition-colors flex-1 max-w-xs">
