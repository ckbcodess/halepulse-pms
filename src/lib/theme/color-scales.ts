/**
 * Tailwind v4 reference color scales in OKLCH.
 *
 * Each scale has 11 shades: 50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950.
 * Values are exact copies from the official Tailwind CSS v4 palette.
 */
...
/** All known neutral scale names. */
export const NEUTRAL_SCALE_NAMES = [
  'slate', 'gray', 'zinc', 'neutral', 'stone',
  'mauve', 'olive', 'mist', 'taupe',
] as const;

export type NeutralScaleName = (typeof NEUTRAL_SCALE_NAMES)[number];

/** Check if a scale name is a neutral. */
export function isNeutralScale(name: string): boolean {
  return (NEUTRAL_SCALE_NAMES as readonly string[]).includes(name);
}
